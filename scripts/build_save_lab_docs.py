...
FAB = 'https://www.fab.com/listings/5457cca4-c6b2-475a-aded-e74d70f660f7'
...
<header class="site-header"><a class="brand" href="/">Unreal Tools</a><nav aria-label="Product navigation"><a href="/#tools">All tools</a><a href="#install-and-try-the-example">Get started</a><a href="{FAB}" aria-describedby="fab-status">View on Fab ↗</a></nav></header>
...
<div class="actions"><a class="button" href="{FAB}" aria-describedby="fab-status">View on Fab ↗</a><a class="button secondary" href="#install-and-try-the-example">Start here ↓</a></div>
<p class="muted" id="fab-status">Awaiting Fab approval. The store page will be available once the listing is published.</p>
