...
BASE = '/deck-toolkit/'
FAB = 'https://www.fab.com/listings/2225928a-2041-4ae8-b588-83daf3babbef'
...
<div class="actions"><a class="button" href="https://www.fab.com/listings/2225928a-2041-4ae8-b588-83daf3babbef" aria-describedby="fab-availability">Buy on Fab <span aria-hidden="true">&#8599;</span></a><a class="button secondary" href="getting-started/">Start with the example <span aria-hidden="true">↗</span></a><a class="button secondary" href="api/">Browse the API</a></div><p class="purchase-note" id="fab-availability">Available after Fab approval. The product page will open once the listing is published.</p>
...
<div class="layout"><aside class="sidebar" id="docs-nav"><div class="sidebar-label">ULTIMATE DECK<br>BUILDING TOOLKIT</div><label for="doc-search">Find a topic</label><input id="doc-search" type="search" placeholder="Search documentation" autocomplete="off" aria-controls="search-results"><div id="search-results" aria-live="polite"></div><nav aria-label="Documentation">{nav}</nav><div class="sidebar-purchase"><a class="button" href="{FAB}" aria-describedby="sidebar-fab-status">Buy on Fab <span aria-hidden="true">&#8599;</span></a><small id="sidebar-fab-status">Available after Fab approval</small></div><div class="sidebar-version">0.3.0 / UE 5.8 / WIN64</div></aside>
