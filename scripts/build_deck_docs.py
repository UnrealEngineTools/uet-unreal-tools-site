...
<div class="actions"><a class="button" href="getting-started/">Start with the example <span aria-hidden="true">â†—</span></a><a class="button secondary" href="api/">Browse the API</a></div>
...
for i,p in enumerate(PAGES):
    ...
    nxt=f'<a href="{url(PAGES[i+1])}"><small>NEXT</small>{PAGES[i+1]["title"]} â†’</a>' if i+1<len(PAGES) else f'<a href="{BASE}"><small>OVERVIEW</small>Back to the guide â†’</a>'
...
<main id="main"><div class="eyebrow">DECK TOOLKIT / DOCUMENTATION</div><h1>{p['title']}</h1><p class="summary">{p['summary']}</p><article>{p['body']}</article><nav class="pager" aria-label="Previous and next topic">{prev}{nxt}</nav><footer>Â© 2026 Hungry Ghost / Unreal Tools.<br>Independent tools for Unreal Engine. Not affiliated with or endorsed by Epic Games.<br><span>Documentation for version 0.3.0 Â· Updated September 10, 2026</span></footer></main><aside class="toc"><div class="sidebar-label">ON THIS PAGE</div><nav aria-label="On this page">{toc}</nav><a class="back-top" href="#main">Back to top â†‘</a></aside></div></body></html>'''
    dest=OUT/p['slug'];dest.mkdir(exist_ok=True);(dest/'index.html').write_text(doc,encoding='utf-8')
